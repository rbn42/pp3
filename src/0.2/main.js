...
function draw() {
    ...
    var b=[];
    b=a;
    b[0]=obj_pad2.position[0];
    b[1]=obj_pad2.position[1];
    a=[];
//    vec4.transformMat4(b,a,worldMatrix);
    vec4.transformMat4(a,b,viewMatrix);
    for(var i=0;i<3;i++)
        a[i]/=a[3];
    a.pop();
    gl.uniform3fv(shader_main.unimap["u_lightViewPosition"], a );
      
    b=[0,0,1];
    vec3.transformMat3(a,b,viewNormalMatrix);
    vec3.normalize(a,a);
    gl.uniform3fv(shader_main.unimap["u_lightViewNormal"], a );

    b=[1,0,0];
    vec3.transformMat3(a,b,viewNormalMatrix);
    vec3.normalize(a,a);
    gl.uniform3fv(shader_main.unimap["u_lightViewRight"], a );

    b=[0,1,0];
    vec3.transformMat3(a,b,viewNormalMatrix);
    vec3.normalize(a,a);
    gl.uniform3fv(shader_main.unimap["u_lightViewUp"], a );
    gl.uniform1f(shader_main.unimap["u_lightWidth"], obj_pad1.size[0] );
    gl.uniform1f(shader_main.unimap["u_lightHeight"], obj_pad1.size[1] );
    gl.uniform1f(shader_main.unimap["u_shininess"], 4400 );
    /////////////////////////////////////////////
    ...
    gl.uniform4fv(shader_plain.unimap["u_color"], [1, 1, 1, 1]);
    mesh_draw(gl, obj_ball.mesh, shader_plain.attrmap);
