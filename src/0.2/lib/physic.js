...
function physicfawefwaefawfeawf(delta, ball) {
	...
	phydic_movePad(obj_pad2, delta);
 	...
 	quat.multiply(ball.quaternion,out, ball.quaternion); 

//		var temp=mat4.create() ;
//	mat4.rotate(temp, ball.rotationMatrix, ballSpinVectorfawefweafaef, ballSpinVectorfawefweafaef[3]) 
//		mat4.copy(ball.rotationMatrix,temp);
}
